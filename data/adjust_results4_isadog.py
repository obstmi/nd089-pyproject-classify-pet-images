...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    try:
        with open(dogfile, "r") as infile:
            ...
            while line:
                ...
                # Adds dog name to dognames_dic if not already present
        ...
        print(
            f"Warning: dogfile '{dogfile}' not found. No dog names loaded.",
            file=sys.stderr,
        )
    except Exception as e:
        print(f"Error reading dogfile '{dogfile}': {e}", file=sys.stderr)
    ...
    # shorter variant using conditional expressions:
    # for key, value in results_dic.items():
    #     pet_is_dog = 1 if value[0] in dognames_dic else 0
    #     classifier_is_dog = 1 if value[1] in dognames_dic else 0
