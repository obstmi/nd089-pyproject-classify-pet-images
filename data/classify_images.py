...
def classify_images(images_dir, results_dic, model):
    ...
    """
    # Check if images_dir is valid and exists
    if not images_dir or not path.isdir(images_dir):
        print("Error: Invalid or non-existent directory:", images_dir)
        return

    # Check if results_dic is not empty
    if not results_dic:
    ...
    # classifier function
    for filename in results_dic:  # key is the filename
        ...
        # defines truth as pet image_label
        image_label = results_dic[filename][0]
